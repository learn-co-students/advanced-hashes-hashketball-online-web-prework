  ...
  home: {
    ...
    colors: ["Black, White"],
      players: {
        ...
        name: "Brook Lopez", number: 11, shoe: 17, points: 17, rebounds: 19,
        ...
        name: "Jason Terry", number: 31, shoe: 15, points: 19, rebounds: 2 ,
            assists: 1, steals: 4, blocks: 11, slam_dunks: 1}},
away: {
  team_name: "Charlotte Hornets",
    colors: ["Turquoise, Purple"],
      players: {
        name:"Jeff Adrien", number: 4, shoe: 18, points: 10, rebounds: 1,
