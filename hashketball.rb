...
def num_points_scored(desired_player_name)
  game_hash.each do |_place, team|
    team.each do |attribute, data|
      next unless attribute == :players

      data.each do |player|
        return player[:points] if player[:player_name] == desired_player_name
      end
    end
  end
end
...
def shoe_size(desired_player_name)
  game_hash.each do |_place, team|
    team.each do |attribute, data|
      ...
      data.each do |player|
        return player[:shoe] if player[:player_name] == desired_player_name
      end
    end
  end
end
  ...
  game_hash.collect do |place, team|
    team.each do |attribute, _data|
      ...
      game_hash[place][attribute].each do |player|
        ...
        new_hash = player.delete_if do |keys, _values|
          keys == :player_name
        end
      end
    end
  ...
  game_hash.each do |_team, game_data|
    game_data[:players].each do |player|
      if player[:shoe] > biggest_shoe
        ...
        numba_rebounds = player[:rebounds]
      end
    end
  end
numba_rebounds 
...
def winning_team 
  ...
  scores.max_by { |keys, values| values }.first
end
